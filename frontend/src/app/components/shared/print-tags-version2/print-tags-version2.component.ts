...
@Component({
  selector: 'app-print-tags-version2',
  templateUrl: './print-tags-version2.component.html',
  styleUrls: ['./print-tags-version2.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatFormFieldModule,
...
export class PrintTagsVersion2Component {
  visitId?: number;
  collectionId?: number;
  ...
  //initial selected tags for print version-2
  tags: string[] = [
    '{latin_name}',
    '{sex_symbol}',
    '\n',
