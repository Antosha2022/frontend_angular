...
@Component({
  selector: 'app-print-tags-version1',
  templateUrl: './print-tags-version1.component.html',
  styleUrls: ['./print-tags-version1.component.scss'],
  standalone: true,
  imports: [
    FormsModule,
    MatFormFieldModule,
...
export class PrintTagsVersion1Component {
  visitId?: number;
  collectionId?: number;
  ...
  //initial selected tags for print version-1
  tags: string[] = [
    '{visit_location}',
    '#{number}',
    '{sex_symbol}',
